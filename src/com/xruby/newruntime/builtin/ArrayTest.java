...
public class ArrayTest extends TestCase {
	public void testInit() {
		...
		assertEquals(RubyConstant.QTRUE, array.callMethod("==", new RubyValue[]{array}));
	...
	public void testAccess() {
		...
		// 1 element
		array.callMethod("[]=", new RubyValue[]{index0, value0});
		...
		array.callMethod("[]=", new RubyValue[]{index2, value2});
	...
	public void testEquals() {
		...
		array1.callMethod("[]=", new RubyValue[] {RubyFixnum.int2Fix(0), RubyFixnum.int2Fix(1)});
		assertEquals(RubyConstant.QFALSE, array0.callMethod("==", array1));
	}
	
	public void testConcat() {
		RubyValue array0 = RubyRuntime.arrayClass.newInstance();
		array0.callMethod("[]=", new RubyValue[] {RubyFixnum.int2Fix(0), RubyFixnum.int2Fix(0)});
	...
	public void testTimes() {
		RubyValue array = RubyRuntime.arrayClass.newInstance();
		array.callMethod("[]=", new RubyValue[] {RubyFixnum.int2Fix(0), RubyFixnum.int2Fix(0)});
	...
	public void testPush() {
		...
		result = array.callMethod("push", new RubyValue[] {pushValue0, pushValue1});
		assertEquals(result, array);
		assertEquals(3, ((RubyFixnum)array.callMethod("length")).longValue());
	...
	public void testPop() {
		...
		array.callMethod("[]=", new RubyValue[] {popValue, popValue});
	...
	public void testInclude() {
		...
		array.callMethod("[]=", new RubyValue[] {includeValue, includeValue});
