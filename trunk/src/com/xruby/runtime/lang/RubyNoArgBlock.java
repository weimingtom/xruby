...
public abstract class RubyNoArgBlock extends RubyBlock {
    public RubyNoArgBlock(RubyValue self, RubyValue arg, RubyArray args, RubyBlock block, RubyModule scope, boolean definedInAnotherBlock) {
        super(0, false, 0, self, arg, args, block, scope, definedInAnotherBlock);
    }
